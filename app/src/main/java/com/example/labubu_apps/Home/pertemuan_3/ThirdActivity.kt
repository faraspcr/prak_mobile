package com.example.labubu_apps.Home.pertemuan_3
...
import com.example.labubu_apps.utils.NotificationHelper
import com.example.labubu_apps.utils.PermissionHelper
import com.example.labubu_apps.utils.ReminderHelper
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (PermissionHelper.isNotificationPermissionRequired()) {
            ...
            binding.btnKirim.setOnClickListener {
                ...
                Toast.makeText(this, "$noTujuan", Toast.LENGTH_SHORT).show()
